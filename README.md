...
```bash
git clone https://github.com/kunalb96/voting-app.git
cd voting-app
```
## 📸 Screenshots
...
```bash
docker build -t kunalb96/voting-app:latest .
```

### 📤 Push to Docker Hub

```bash
docker push kunalb96/voting-app:latest
```
...
git --version
git config --global user.name "Kunal Bhavasar"
git config --global user.email "Kunal Bhavasar "
git config --list 
git clone https://github.com/kunalb96/voting-app.git
cd voting-app
